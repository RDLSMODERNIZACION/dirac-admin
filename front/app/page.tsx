...
const labels:Record<Section,string>={dashboard:'Resumen ejecutivo',accounts:'Cuentas y liquidez',jobs:'Trabajos',services:'Servicios',works:'Obras',clients:'Clientes',suppliers:'Proveedores y contratistas',stock:'Stock de materiales',purchases:'Compras',finance:'Finanzas',reports:'Reportes y ratios'};
