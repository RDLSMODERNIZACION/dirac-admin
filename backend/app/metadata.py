...
TABLES: dict[str, dict] = {
    ...
    "works": {
        "writable": ["code", "client_id", "name", "description", "type", "status", "start_date", "end_date", "contract_amount", "monthly_amount", "billing_frequency", "estimated_cost", "progress_percent", "notes"],
